...
public class Assignments {
    public void exercise1() throws IOException {
        ...
        System.out.println("Enter a name you wish to surround between < and > :");
        System.out.println("Remember to click on the console in order to avoid typing in the code window :) ");
    ...
    public void exercise2() throws IOException {
        System.out.println("Exercise 2 number of characters:");
    ...
    public void exercise10() throws IOException {
        ...
        String inputAllowed = reader.readLine();
        String text="";
        boolean changedChar;
        for(int i=0;i<input.length();i++){
            changedChar=false;
    ...
    public void exercise11() throws IOException {
    ...
    public void exercise12() throws IOException {
        ...
        System.out.println("Result the longest chain is "+longestChain+" long ");
    }

    public void exercise13() throws IOException{
       ...
       // boolean hasChangedSentence=false;
        ...
        System.out.println("Result test :"+text);
    }
    //TODO, Not enough time man and JavaFX is f***ing waiting....
    public void exercise14() throws IOException{
